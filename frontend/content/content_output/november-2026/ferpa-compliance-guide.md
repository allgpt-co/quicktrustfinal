---
meta_description: "Complete FERPA compliance guide for EdTech companies and education vendors. Learn what FERPA requires, who must comply, data protection requirements, and how to win school district contracts."
target_keyword: "ferpa compliance"
secondary_keywords: "FERPA requirements, FERPA for EdTech, FERPA data protection, student privacy, FERPA COPPA compliance"
...
### The school consent mechanism under COPPA
...
### Where FERPA consent and COPPA consent diverge

The overlap is not perfect. Key differences include:

| Requirement | FERPA | COPPA |
|---|---|---|
| **Who it regulates** | Educational institutions receiving federal funding | Operators of online services directed to children under 13 |
| **Enforcement** | Department of Education (can withdraw federal funding) | FTC (civil penalties up to $50,120 per violation) |
| **Consent mechanism** | School official exception eliminates need for individual consent | School can provide consent for educational purposes only |
| **Data use restriction** | Must be for purposes specified in the school agreement | Must be for educational purposes; no commercial use |
...
For a detailed guide on building an incident response plan that meets compliance requirements across frameworks, see our [incident response plan guide](/content/november-2026/incident-response-plan-compliance-guide).
...
| FERPA Requirement | SOC 2 Trust Service Criteria |
|---|---|
| Access controls for student data | CC6.1 - CC6.3 (Logical and physical access) |
| Encryption of student data | CC6.1, CC6.7 (Data protection) |
| Audit logging | CC7.1 - CC7.2 (System monitoring) |
| Incident response and breach notification | CC7.3 - CC7.5 (Incident management) |
| Vendor/subprocessor management | CC9.2 (Risk mitigation) |
| Data retention and deletion | CC6.5 (Data lifecycle management) |
| Change management | CC8.1 (Change management) |
| Employee training | CC1.4 (Commitment to competence) |
...
For a comprehensive guide to the SOC 2 framework, including what auditors look for and how to prepare efficiently, see our [SOC 2 Compliance Guide](/content/march-2026/pillar-soc2-complete-guide).
...
**[Start your EdTech compliance program -- quicktrustapp.com](https://quicktrustapp.com)**
...
- [Data Processing Agreement Guide](/content/november-2026/data-processing-agreement-guide)
- [Information Security Policy Guide](/content/november-2026/information-security-policy-guide)
