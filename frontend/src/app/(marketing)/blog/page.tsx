...
const categoryIcons: Record<string, string> = {
  ...
  'August 2026': 'Illustrative Scenarios',
...
const categoryDescriptions: Record<string, string> = {
  ...
  'August 2026': 'Hypothetical implementation scenarios for discussing scope, controls and evidence. These are not verified customer outcomes.',
